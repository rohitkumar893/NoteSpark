    ...
    <div className='w-full max-h-screen'>
      ...
      <div className='h-full w-full flex flex-col justify-center items-center'>
        ...
        <button
          ...
          className='fixed bg-blue-500 cursor-pointer right-10 bottom-10 w-[50px] h-[50px] sm:h-[60px] md:w-[60px] md:h-[70px] text-white font-semibold text-[35px] md:text-[40px] flex justify-center rounded-full'>
          +
        </button>
